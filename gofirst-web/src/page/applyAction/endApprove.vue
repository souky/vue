    ...
    <div id="delayed" style="height: 100%;">
        <el-row class="yourAddress normalRow" style="margin-bottom:10px;">
            <el-col :span="24" class="normalCol">
                ...
                <el-breadcrumb-item>终止申请审批</el-breadcrumb-item>
                </el-breadcrumb>
            </el-col>
        </el-row>
        ...
        <el-form ref="formInfo" :rules="rules" :model="formData" label-width="130px" size="small">
            <el-row class="rowInfo">
                <el-col class="baseInfoTop">终止申请</el-col>
            </el-row>
            <el-row class="rowInfo">
                ...
                <el-col :span="24">
                    <el-form-item label="终止原因:" prop="reasonContent" >
                        <el-col :span="20">
                        <el-input v-model="formData.reasonContent" type="textarea" :rows="2" placeholder="请输入终止原因" :disabled="true"></el-input>
                        </el-col>
                    </el-form-item>
                </el-col>
            </el-row>
        ...
        return {
            ...
            rules: {
                delayedDays:[
                    ...
                    { type: 'number', message: '终止时间请输入数字', trigger: 'blur' }
                ],
                reasonContent:[
    ...
    methods:{
        getInfo(){
            ...
            this.postHttp("apply/selectByObjectUnApprove", obj, res => {
                console.log(res.data.auditState);
