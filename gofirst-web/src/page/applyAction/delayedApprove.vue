    ...
    <div id="delayed" style="height: 100%;">
        <el-row class="yourAddress normalRow" style="margin-bottom:10px;">
            <el-col :span="24" class="normalCol">
                ...
                <el-breadcrumb-item>延期申请审批</el-breadcrumb-item>
                </el-breadcrumb>
            </el-col>
        </el-row>
            ...
            <el-row class="rowInfo">
                ...
                <el-col :span="8">
                    <el-form-item label="延期天数:" prop="delayedDays" >
                        <el-col :span="20">
                                <el-input v-model.number="formData.delayedDays" maxlength="10" :disabled="true"></el-input>
                        </el-col>
                    </el-form-item>
                </el-col>
                <el-col :span="24">
                    <el-form-item label="延期原因:" prop="reasonContent" >
                        <el-col :span="20">
                        <el-input v-model="formData.reasonContent" type="textarea" :rows="2" placeholder="请输入延期原因" :disabled="true"></el-input>
                        </el-col>
                    </el-form-item>
                </el-col>
            </el-row>
        ...
        return {
            ...
            rules: {
                delayedDays:[
                    ...
                    { type: 'number', message: '延期时间请输入数字', trigger: 'blur' }
                ],
                reasonContent:[
