            ...
            <el-row class="rowInfo">
                ...
                <el-col :span="8">
                    <el-form-item label="延期天数:" prop="delayedDays">
                        <el-col :span="20">
                                <el-input v-model.number="formData.delayedDays" maxlength="10"></el-input>
                        </el-col>
                    </el-form-item>
                </el-col>
                <el-col :span="24">
                    <el-form-item label="延期原因:" prop="reasonContent">
                        <el-col :span="20">
                        <el-input v-model="formData.reasonContent" type="textarea" :rows="2" placeholder="请输入延期原因"></el-input>
                        </el-col>
                    </el-form-item>
                </el-col>
