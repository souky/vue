  ...
  <div id="appraisal" class="appraisal" style="height: 100%;">
    ...
    <div id="tabb" class="tabb mainItem dynamicTable">
      <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%"
        ...
        ></el-table-column>
        <el-table-column prop="entrustRequire" align='center' label="鉴定要求" show-overflow-tooltip
        ></el-table-column>
        <el-table-column align='center' prop="entrustDate" :formatter='dateFormat' label="要求完成时间" width="120px"
                         show-overflow-tooltip>
           <template slot-scope="scope" v-if="scope.row.restDays != null">
             <font v-if="scope.row.restDays > 5">{{scope.row.restDays}}天剩余</font>
             <font style="color:#E6A23C;" v-if="scope.row.restDays < 5 && scope.row.restDays > 0">{{scope.row.restDays}}天剩余</font>
             <font style="color:#F56C6C;" v-if="scope.row.restDays <= 0">超期{{(0-scope.row.restDays)}}天</font>
           </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      querys() {
        ...
        this.postHttp("registers/appraisalList", data, res => {
