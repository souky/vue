<template>
  <div id="dnaList" style="height: 100%;">
...
<script>
  export default {
    ...
    methods: {
      ...
      jump() {
        this.$router.push('/entrustChoice_dna');
      },
      reminder() {
...
<style>
  ...
  #dnaList .yourAddress .el-input--prefix .el-input__inner {
    padding-left: 30px;
    margin-top: 4px;
  }

  #dnaList .yourAddress .el-input--suffix .el-input__inner {
    padding-right: 30px;
    margin-top: 4px;
  }
  ...
  #dnaList .el-row .normalCol {
    height: 3em;
    line-height: 3em;
    font-size: 14px;
  }

  #dnaList .yourAddress .ban {
  ...
  #dnaList .tabb .el-table th div {
    height: 29px;
    line-height: 29px;
  }

  #dnaList .tabb .el-table__header tr,
  #dnaList .tabb .el-table__header th {
    padding: 0;
    height: 40px;
  ...
  #dnaList .tabb .el-table__body tr,
  #dnaList .tabb .el-table__body td {
    padding: 0;
    height: 40px;
  }
