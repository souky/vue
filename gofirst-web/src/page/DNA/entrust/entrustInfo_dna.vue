...
export default {
    ...
    methods: {
      ...
      getRegisterInfo(){
        this.postHttp("consignment/selectInfoByIdWhtiExt",this.consignmentId,res =>{
			if(res.code == '0'){
      ...
      createWord(){
        let param = {};
        this.loading = true;
        param['registerId']=this.getData("consignmentId");
      ...
      submitAuc(){
        let param = {};
        param['registerId']=this.getData("consignmentId");
        console.log("id",this.getData("consignmentId"))
         ...
         */
        wordList(){
        this.pageOffice('word/registerWordList.html',{registerId:this.getData("consignmentId")});
        },
