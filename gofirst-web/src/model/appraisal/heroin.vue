<template data-title="海洛因鉴定书">
  <div class="heroinA" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">海洛因鉴定书</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.postHttp("registers/getRegisterForJD",{registerId:this.regRow.registerId,checkDocType:3},res=>{
      ...
      this.$set(this.form, 'c010',Constant.heroin.identificationBook.experimentalProcess);
    })
  },
  methods:{
    dealData(){
