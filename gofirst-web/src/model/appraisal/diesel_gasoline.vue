<template data-title="微量物证检验报告">
  <div class="dieselGasoline" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">微量物证检验报告</div>
      ...
      this.postHttp("check/selectByCheck",data,res=>{
        ...
        if(res.data != null){
          ...
          this.postHttp("check/initAppraisal",dataInit,res=>{
            ...
            this.$set(this.form, 'c010',Constant.dieselGasoline.identificationBook.experimentalProcess);
