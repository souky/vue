<template data-title="法医学人体损伤程度鉴定书">
  <div class="" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="100px" size='small'>
      <div class="title-center">法医学人体损伤程度鉴定书</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.postHttp("registers/getRegisterForJD",{registerId:this.regRow.registerId,checkDocType:2},res=>{
      ...
      this.$set(this.form, 'c010',Constant.forensicClinic.identificationBook.experimentalProcess);
    })
  },
  methods:{
    dealData(){
