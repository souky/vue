<template data-title="枪支性能检验">
  <div class="" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">枪支性能检验</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.postHttp("registers/getRegisterForJD",{registerId:this.regRow.registerId,checkDocType:3},res=>{
      ...
      this.$set(this.form, 'c010',Constant.bulletRecognition.identificationBook.experimentalProcess);
      this.$set(this.form, 'checkResultContent',Constant.bulletRecognition.identificationBook.testConclusion);
    });
