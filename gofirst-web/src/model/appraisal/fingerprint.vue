<template data-title="指纹鉴定书">
  <div class="fingerprint" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">指纹鉴定书</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.postHttp("registers/getRegisterForJD",{registerId:this.regRow.registerId,checkDocType:2},res=>{
      ...
      this.$set(this.form, 'c010',Constant.fingerprint.identificationBook.experimentalProcess);
      this.$set(this.form, 'c011',Constant.fingerprint.identificationBook.dataRecord);
      this.$set(this.form, 'checkResultContent',Constant.fingerprint.identificationBook.testConclusion);
    });
    this.dealData();
  },
  methods:{
