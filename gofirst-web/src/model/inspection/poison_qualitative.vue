<template data-title="常见毒物定性检验记录表">
  <div class="poisionQualit" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="100px" size='small'>
      <div class="title-center">常见毒物定性检验记录表</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.$set(this.form, 'c004',Constant.poision.inspectionReport.experimentalProcess);
    this.$set(this.form, 'c005',Constant.poision.inspectionReport.analysisCondition);
    this.$set(this.form, 'c006',Constant.poision.inspectionReport.remark);
    this.$set(this.form, 'checkResultContent',Constant.poision.inspectionReport.testConclusion);
    this.dealData();
