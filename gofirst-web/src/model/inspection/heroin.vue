<template data-title="海洛因GC定性检验记录">
  <div class="heroinI" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">海洛因GC定性检验记录</div>
      ...
      <div class="form-body">
        ...
        <el-form-item class="form-items rows" label="检材类型及数量:">
      ...
      <div class="title-level one"><i class="el-icon-tickets"></i>仪器分析条件</div>
      <div class="editor-body">
        <tinymce-editor ref="editor" v-model="form.c007" ></tinymce-editor>
      </div>
      <div class="title-level one"><i class="el-icon-tickets"></i>仪器分析数据记录</div>
      <div class="editor-body">
        <tinymce-editor ref="editor" v-model="form.c008" ></tinymce-editor>
      </div>
      <div class="title-level one"><i class="el-icon-tickets"></i>分析结果</div>
      <div class="editor-body">
        <tinymce-editor ref="editor" v-model="form.c009" ></tinymce-editor>
      </div>
...
export default {
  ...
  mounted:function(){
    ...
    this.$set(this.form,"c004",Constant.heroin.inspectionReport.evid);
    this.$set(this.form,"c006",Constant.heroin.inspectionReport.experimentalProcess);
    this.$set(this.form,"c007",Constant.heroin.inspectionReport.dataRecord);
    this.$set(this.form,"c008",Constant.heroin.inspectionReport.analysisCondition);
    this.$set(this.form,"c009",Constant.heroin.inspectionReport.result);
    this.$set(this.form,"checkResultContent",Constant.heroin.inspectionReport.testConclusion);
    this.dealData();
