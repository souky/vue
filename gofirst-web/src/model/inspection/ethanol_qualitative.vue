<template data-title="乙醇定量检验记录表">
  <div class="" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="100px" size='small'>
      <div class="title-center">乙醇定量检验记录表</div>
      <div class="title-level one"><i class="el-icon-tickets"></i>基本信息</div>
      <div class="form-body">
        <el-form-item class="form-items" label="受理编号:">
          <el-input disabled v-model="form.c001"></el-input>
        </el-form-item>
        <el-form-item class="form-items" label="检材编号:">
          <el-input disabled v-model="form.c002"></el-input>
        </el-form-item>
        <el-form-item class="form-items" label="检材名称:">
          <el-input disabled v-model="form.c003"></el-input>
        </el-form-item>
      ...
      <div class="title-level one"><i class="el-icon-tickets"></i>实验过程</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.$set(this.form, 'c003',this.rows.names);
    this.$set(this.form, 'checkUser',this.getData("userName"));
    this.$set(this.form, 'c007',this.timeF(new Date()).format('YYYY年MM月DD日'));
    // 常量数据放置
    this.$set(this.form, 'c004',Constant.ethanol.inspectionReport.experimentalProcess);
    this.$set(this.form, 'c005',Constant.ethanol.inspectionReport.analysisCondition);
    this.$set(this.form, 'c006',Constant.ethanol.inspectionReport.dataRecord);
    this.$set(this.form, 'checkResultContent',Constant.ethanol.inspectionReport.testConclusion);
    this.dealData();
