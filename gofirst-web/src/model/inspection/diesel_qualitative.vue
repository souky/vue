<template data-title="柴油残留物定性检验记录表">
  <div class="dieselQualitative" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">柴油残留物定性检验记录表</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.$set(this.form, 'c004',Constant.dieselGasoline.inspectionReport.diesel.experimentalProcess);
    this.$set(this.form, 'c005',Constant.dieselGasoline.inspectionReport.diesel.analysisCondition);
    this.$set(this.form, 'checkResultContent',Constant.dieselGasoline.inspectionReport.diesel.testConclusion);
    this.$set(this.form, 'c006',Constant.dieselGasoline.inspectionReport.diesel.remark);
    this.dealData();
