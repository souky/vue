<template data-title="手印检验记录">
  <div class="fingerprintI" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">手印检验记录</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.$set(this.form,"c008",Constant.fingerprint.inspectionReport.experimentalProcess);
    this.dealData();
