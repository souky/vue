<template data-title="文件检验记录">
  <div class="filesI" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">文件检验记录</div>
      ...
      <div class="form-body">
        ...
        <el-form-item class="form-items rows" label="检验项目:">
        ...
        <el-form-item class="form-items rows" label="检验要求:">
          <el-input v-model="form.c009" disabled></el-input>
        </el-form-item>
      </div>
      ...
      <div class="title-level one"><i class="el-icon-tickets"></i>检验</div>
      <div class="editor-body">
...
export default {
  ...
  mounted:function(){
    ...
    this.postHttp("registers/getRegisterForJD",{registerId:this.regRow.registerId},res=>{
      // 常量数据放置
      this.$set(this.form, 'c009',res.data.entrustRequire);
    });
    this.dealData();
