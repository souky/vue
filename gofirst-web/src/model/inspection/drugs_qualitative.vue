<template data-title="毒品定性检验记录表">
  <div class="drugsQualitative" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">毒品定性检验记录表</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.$set(this.form, 'c004',Constant.drugs.inspectionReport.qualitative.experimentalProcess);
    this.$set(this.form, 'c005',Constant.drugs.inspectionReport.qualitative.analysisCondition);
    this.$set(this.form, 'checkResultContent',Constant.drugs.inspectionReport.qualitative.testConclusion);
    this.$set(this.form, 'c006',Constant.drugs.inspectionReport.qualitative.remark);
    this.dealData();
