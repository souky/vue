<template data-title="汽油残留物定性检验记录表">
  <div class="gasolineQualitative" v-loading='loading'>
    <el-form ref="form" :model="form" label-width="120px" size='small'>
      <div class="title-center">汽油残留物定性检验记录表</div>
...
export default {
  ...
  mounted:function(){
    ...
    this.$set(this.form, 'c004',Constant.dieselGasoline.inspectionReport.gasoline.experimentalProcess);
    this.$set(this.form, 'c005',Constant.dieselGasoline.inspectionReport.gasoline.analysisCondition);
    this.$set(this.form, 'checkResultContent',Constant.dieselGasoline.inspectionReport.gasoline.testConclusion);
    this.$set(this.form, 'c006',Constant.dieselGasoline.inspectionReport.gasoline.remark);
    this.dealData();
